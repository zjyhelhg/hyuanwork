...
//   const [views, setViews] = useState(1009)  // 起步1000
...
//             navLinks.map((link, index) => (
//               <a onClick={() => setActiveLink(link.href)} key={index} href={link.href}
//                 className={` ${activeLink === link.href ? "text-blue-600 after:w-full" : "text-gray-600 hover:text-gray-900"} text-sm font-medium relative after:bottom-0 after:absolute after:left-0 after:h-0.5 after:w-0 hover:after:w-full after:bg-blue-600 after:transition-all`}
//               >
//                 {link.label}
//               </a>
//             ))
...
//                   setActiveLink(link.href)
//                   setIsMenuOpen(false)
//                 }} className={`block ${activeLink === link.href ? "text-blue-600 after:w-full" : "text-gray-600 hover:text-gray-900"} font-medium py-2 text-sm`} href={link.href}>
//                   {link.label}
//                 </a>
//               ))
//             }
